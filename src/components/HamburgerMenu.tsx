  ...
  const visibleSections = sections
    .map((section) => ({
      ...
      items: section.items.filter((item) =>
        role === "owner" ? true : !item.ownerOnly
      ),
    }))
  ...
  return (
    <>
      ...
      <button
        ...
        className="text-white/80 hover:text-white p-1.5 -ml-1.5 rounded-lg transition-colors"
      ...
      {/* Slide-out drawer */}
      <div
        className={`fixed top-0 left-0 bottom-0 w-[280px] bg-white z-[70] transform transition-transform duration-300 ease-out ${
      ...
      >
        ...
        {/* Menu items */}
        <div className="overflow-y-auto h-[calc(100%-80px-env(safe-area-inset-top))] pb-20">
                ...
                return (
                  <Link
                    ...
                    className={`flex items-center gap-3 px-5 py-2.5 transition-colors ${
                      isActive
                        ? "bg-porch-brown/10 text-porch-brown font-semibold"
                        : "text-gray-700 hover:bg-gray-50"
                    }`}
                  >
                    <span className={isActive ? "text-porch-brown" : "text-gray-400"}>
                      {item.icon}
                    </span>
